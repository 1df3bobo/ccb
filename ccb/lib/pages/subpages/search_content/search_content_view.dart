...
class SearchContentPage extends BaseStateless {
  ...
  Widget _spanText(String content, keyword) {
    ...
    return Text.rich(
      TextSpan(
        children: _highlightKeywords(content, keyword),
      ),
    );
  }
    ...
    return state.name == '电子印章'
        ? ListView(
            ...
            children: [
              ...
              ).withPadding(left: 20.w, right: 20.w, top: 5.w,bottom: 6.w),
              Container(
                          ...
                          return Row(
                            children: [
                              Image(
                                ...
                                left: 20.w,right: 12.w
                              ),
                              BaseText(text: data['name'],
                                style: TextStyle(
                                  fontWeight: FontWeight.bold,
                                  fontSize: 15.sp,
                                ),)
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    color: Colors.white,
                    borderRadius: BorderRadius.all(Radius.circular(8.w))),
                child: Image(image: 'dzyz_tem'.png3x,fit: BoxFit.fitWidth,),
              ),
              Container(
        ...
        : ListView(
            ...
            children: [
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ).withPadding(left: 20.w, right: 20.w, top: 5.w,),
                    Container(
                      width: 340.w,
                      height: 100.w,
              ...
              Image(image: 'ic_search_bottom'.png3x)
                  .withPadding(top: 10.w, left: 12.w, right: 12.w),
            ],
          );
  }
}
