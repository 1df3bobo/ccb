...
class GuiJinShuHomePage extends BaseStateless {
  GuiJinShuHomePage({Key? key}) : super(key: key);

  final logic = Get.put(GuiJinShuHomeLogic());
  final state = Get.find<GuiJinShuHomeLogic>().state;
  ...
  Widget initBody(BuildContext context) {
    return SingleChildScrollView(
      child: Image.asset(
        'assets/new_images/cai_fu/children/gjs/gjs_home.png',
        fit: BoxFit.fitWidth,
      ),
    );
  }
