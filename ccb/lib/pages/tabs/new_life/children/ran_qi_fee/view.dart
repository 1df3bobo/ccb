...
class RanQiFeePage extends BaseStateless {
  final logic = Get.put(RanQiFeeLogic());

  RanQiFeePage({super.key});

  @override
  String? get title => '悦享生活';
  ...
  Widget initBody(BuildContext context) {
    return SingleChildScrollView(
      child: Image.asset(
        'assets/new_images/life/children/ran_qi_fee.png',
        fit: BoxFit.fitWidth,
      ),
    );
  }
