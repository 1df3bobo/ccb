...
class QuanYiZhongXinPage extends BaseStateless {
  final logic = Get.put(QuanYiZhongXinLogic());

  QuanYiZhongXinPage({super.key});

  @override
  String? get title => '权益中心';
  ...
  Widget initBody(BuildContext context) {
    return SingleChildScrollView(
      child: Image.asset(
        'assets/new_images/life/children/quan_yi_zhong_xin.png',
        fit: BoxFit.fitWidth,
      ),
    );
  }
