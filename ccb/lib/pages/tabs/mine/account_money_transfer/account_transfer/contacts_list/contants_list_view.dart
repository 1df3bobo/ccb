...
class ContactsListPage extends BaseStateless {
  ContactsListPage({Key? key}) : super(key: key,title:'全部收款人');
            ...
            image: 'ic_jsyh'.png3x,
              ...
              height: 18.w,
                ...
                Column(
                  ...
                  children: [
                    BaseText(text: model.realName,fontSize: 16.sp,),
                    SizedBox(height: 4.w,),
                    Row(
                      children: [
                        BaseText(text: model.bankName,fontSize: 13.sp,color: const Color(0xff666666),),
    ...
    return Row(
      children: [
        ...
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            BaseText(text: model.name,fontSize: 16.sp,),
            SizedBox(height: 4.w,),
           Row(
             children: [
               BaseText(text: model.bankName,fontSize: 13.sp,color: const Color(0xff666666),),
