import 'package:ccb/pages/tabs/mine/account_details/component/account_details_item_widget.dart';
import 'package:ccb/pages/tabs/mine/account_details/component/bill_filter_widget.dart';
...
class AccountDetailsPage extends BaseStateless {
            ...
            child: Column(
              children: [
                GetBuilder(
                  ...
                  // DetailsPicker.showHeadTime(context,
                  //     headerNotifier: state.headerNotifier);
                  NewPicker.showNewTime(newHeadNotifier: state.newHeaderNotifier);
                }),
                GetBuilder(
                  builder: (AccountDetailsLogic c) {
                    return Row(
            ...
            GetBuilder(
              builder: (AccountDetailsLogic c) {
                return _topTagWidget(
                        title: '时间',
                        image:
                            state.orderSort == '2' ? 'ic_mx_sx2' : 'ic_mx_sx3',
                        color:
