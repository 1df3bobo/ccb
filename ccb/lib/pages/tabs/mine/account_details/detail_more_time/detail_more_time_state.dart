...
class DetailMoreTimeState {
  ...
  PickerMoreHeaderNotifier headerNotifier = PickerMoreHeaderNotifier();
  NewMorePickerHeaderNotifier newHeaderNotifier = NewMorePickerHeaderNotifier();
  ...
  DetailMoreTimeState() {
    ...
    restData();
    if (monthTime1 == '') {
      monthTime1 = "${lastMonthDate.year}年${lastMonthDate.month}月";
    }
  }
