...
class PickerHeader1 extends StatefulWidget {
  final Function callBack;
  final Picker picker;
  final PickerHeaderNotifier? controller;
  ...
  @override
  State<PickerHeader1> createState() => _PickerHeader1State();
}

class _PickerHeader1State extends State<PickerHeader1> {
...
class PickerHeaderNotifier extends ChangeNotifier {
  String type = '';
  String time = '';
  List<int> selected = [];
