...
import '../person_transfer/person_transfer_logic.dart';
import '../person_transfer/person_transfer_state.dart';

class PersonPermanentWidget extends StatefulWidget {
  const PersonPermanentWidget({super.key});

  @override
  State<PersonPermanentWidget> createState() => _PersonPermanentWidgetState();
}

class _PersonPermanentWidgetState extends State<PersonPermanentWidget> {
