...
import 'hold_page_logic.dart';
import 'hold_page_state.dart';

class Hold_pagePage extends BaseStateless {
  Hold_pagePage({Key? key}) : super(key: key, title: '银行卡持有证明');

  final Hold_pageLogic logic = Get.put(Hold_pageLogic());
  final Hold_pageState state = Get.find<Hold_pageLogic>().state;
  ...
  List valueList = [
    AppConfig.config.balanceLogic.memberInfo.bankList.first.bankCard.maskBankCardNumber(),
    '电子邮件',
    '请正确输入本人邮箱地址',
  ];
