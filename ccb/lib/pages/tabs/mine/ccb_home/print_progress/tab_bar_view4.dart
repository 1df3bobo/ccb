...
class TabBarView4 extends StatefulWidget {
  const TabBarView4({super.key});

  @override
  State<TabBarView4> createState() => _TabBarView4State();
}

class _TabBarView4State extends State<TabBarView4> {
  ...
  Widget build(BuildContext context) {
    ...
    return list.isEmpty
      ...
      children: [
        ...
        :refreshWidget(child: ListView.builder(itemBuilder: (context,index){
          ...
          children: [
            Row(
              ...
              children: [
                ...
                BaseText(text: '已完成',color: Colors.blue,),
              ],
            ),
