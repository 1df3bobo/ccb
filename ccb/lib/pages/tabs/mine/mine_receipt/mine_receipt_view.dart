                                    ...
                                    child: Row(
                                      children: [
                                        BaseText(
                                          text: state.nameList[index],
                                          style: TextStyle(
                                              fontSize: show ?16.sp:11.sp,
                                              color:show ? const Color(0xff286F9F) :  const Color(0xff6D7276),
                                              fontWeight: show ? FontWeight.w500:FontWeight.normal
                                          ),
                                        ).withContainer(width: 80.w),
                                        Row(
                                          children: [
                                            SizedBox(
                                              width: index == 12?null:(1.sw * 0.8) - 120.w,
                                              child: BaseText(
                                                maxLines: 5,
                                                fontSize: 12.sp,
                                                color: index == 3? const Color(0xff286F9F) :const Color(0xff3D4045),
                                                text: logic.valueName(index),
                                              ),
                                            ),

                                            (logic.show == true && index == 12)?Obx(() =>
                                                BaseText(
                                                    text: logic.showCardNumber.value?'隐藏':'显示完整卡号',
                                                  fontSize: 12.sp,
                                                  color: Colors.blue,
                                                  ...
                                                  if(state.fistClick && !logic.showCardNumber.value){
                                                    '尊敬的客户，'
                                                        ...
                                                        cancel: const BaseText(text: '不在提示',color: Color(0xff666666),),
                                                        sure: const BaseText(text: '我已经知晓',color: Colors.blue,),
            ...
            children: [
              ...
              Expanded(
                child: Container(
                  ...
                  logic.capturePng(globalKey: state.shareGoodsGlobalKey)
                      .then((value) async {
